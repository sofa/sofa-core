...
describe('sofa.core', function () {
    ...
    describe('sofa.Util', function () {
        ...
        it('should have a method forEach', function () {
        ...
        describe('sofa.Util#forEach', function () {

            it('should be a function', function () {
                expect(typeof util.forEach).toBe('function');
            });
            ...
            it('should handle arguments objects like arrays', function () {
                ...
                util.forEach(args, function (value, key) {
                    log.push(key + ':' + value);
                });
            ...
            it('should handle string values like arrays', function () {
                ...
                util.forEach('bar', function (value, key) {
                    log.push(key + ':' + value);
                });
